      ...
      child: Scaffold(
        ...
        floatingActionButton: FloatingActionButton.extended(
          onPressed: () async {
            ...
            await ProdutosRecord.createDoc(
              ...
              categoria: functions.stringToCategoriaRef(
                  ...
                  currentUserDocument?.estabelecimentoRef?.id),
              active: true,
            ));
            ...
            setState(() {
              ...
              _model.textFieldINfoTextController?.clear();
            });
            setState(() {
                            ...
                            children: [
                              Expanded(
                                child: TextFormField(
                                  ...
                                  focusNode: _model.textFieldINfoFocusNode,
                                  autofocus: false,
                                  obscureText: false,
                                  decoration: InputDecoration(
