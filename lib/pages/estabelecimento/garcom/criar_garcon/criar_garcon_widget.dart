...
import 'criar_garcon_model.dart';
export 'criar_garcon_model.dart';

class CriarGarconWidget extends StatefulWidget {
  const CriarGarconWidget({super.key});

  @override
  State<CriarGarconWidget> createState() => _CriarGarconWidgetState();
}

class _CriarGarconWidgetState extends State<CriarGarconWidget>
    with TickerProviderStateMixin {
  late CriarGarconModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CriarGarconModel());
      ...
      child: Scaffold(
        ...
        floatingActionButton: FloatingActionButton.extended(
          onPressed: () async {
            ...
            _model.userId = await actions.adicionarUsuario(
            ...
            setState(() {
              ...
              _model.textFieldSenhaTextController?.clear();
            });
            FFAppState().valorProduto = 0.0;
            FFAppState().update(() {});
            setState(() {
            ...
            ScaffoldMessenger.of(context).showSnackBar(
              SnackBar(
                content: Text(
                  'Conta de garçom criada com sucesso!',
                  style: TextStyle(
          ...
          children: [
            ...
            Expanded(
              child: Form(
                ...
                child: Padding(
                  padding:
                      EdgeInsetsDirectional.fromSTEB(16.0, 20.0, 16.0, 70.0),
