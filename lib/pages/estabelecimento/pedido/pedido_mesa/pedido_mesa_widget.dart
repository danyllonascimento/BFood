...
import 'pedido_mesa_model.dart';
export 'pedido_mesa_model.dart';

class PedidoMesaWidget extends StatefulWidget {
  const PedidoMesaWidget({super.key});

  @override
  State<PedidoMesaWidget> createState() => _PedidoMesaWidgetState();
}

class _PedidoMesaWidgetState extends State<PedidoMesaWidget>
    with TickerProviderStateMixin {
  late PedidoMesaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PedidoMesaModel());
      ...
      builder: (context) => StreamBuilder<List<PedidosRecord>>(
        stream: queryPedidosRecord(
          ...
          queryBuilder: (pedidosRecord) =>
              pedidosRecord.orderBy('created_time', descending: true),
          singleRecord: true,
        ),
        builder: (context, snapshot) {
          ...
          List<PedidosRecord> pedidoMesaPedidosRecordList = snapshot.data!;

          final pedidoMesaPedidosRecord = pedidoMesaPedidosRecordList.isNotEmpty
              ? pedidoMesaPedidosRecordList.first
              : null;
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    child: Container(
                                      width: 200.0,
                                      decoration: BoxDecoration(),
                                      child: StreamBuilder<List<MesasRecord>>(
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      if (FFAppState().produtosCarrinho.length >
                                          0) {
                                        if (pedidoMesaPedidosRecord != null) {
                                          await PedidosRecord.createDoc(
                                                  currentUserDocument!
                                                      .estabelecimentoRef!)
                                              .set({
                                            ...createPedidosRecordData(
                                              ...
                                              preparando: false,
                                              finalizado: false,
                                              userGarcom: currentUserReference,
                                              mesa: functions.stringToMesaRef(
                                                  _model.dropDownValue,
                                                  currentUserDocument
                                                      ?.estabelecimentoRef?.id),
                                              ...
                                              numeroPedido: valueOrDefault<int>(
                                                pedidoMesaPedidosRecord!
                                                        .numeroPedido +
                                                    1,
                                                1,
                                              ),
