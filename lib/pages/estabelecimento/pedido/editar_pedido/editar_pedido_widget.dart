...
class EditarPedidoWidget extends StatefulWidget {
  const EditarPedidoWidget({
    super.key,
    required this.refPedido,
  });

  final DocumentReference? refPedido;
...
class _EditarPedidoWidgetState extends State<EditarPedidoWidget>
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<PedidosRecord>(
      stream: PedidosRecord.getDocument(widget!.refPedido!),
      builder: (context, snapshot) {
        ...
        final editarPedidoPedidosRecord = snapshot.data!;
                                ...
                                children: [
                                  FlutterFlowIconButton(
                                    ...
                                    onPressed: () async {
                                      ...
                                      FFAppState().editMode = EditModeStruct();
                                      FFAppState().update(() {});
                                      context.safePop();
                                    },
                                  ),
                        ...
                        child: Column(
                          ...
                          children: [
                            Row(
                              ...
                              children: [
                                Text(
                                  'Editar Pedido #${editarPedidoPedidosRecord.numeroPedido.toString()}',
                                ...
                                Expanded(
                                  child: Container(
                                    ...
                                    child: AuthUserStreamWidget(
                                      builder: (context) =>
                                          StreamBuilder<List<MesasRecord>>(
                            ...
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  FFButtonWidget(
                                    onPressed: () async {
                                      context.pushNamed('homePageAddProduto');
                                    },
                                    text: 'Produto',
                                    icon: Icon(
                                      Icons.add,
                                    ...
                                    return ListView.builder(
                                      ...
                                      itemBuilder: (context, produtosAddIndex) {
                                        ...
                                        return BoxProdutoItemWidget(
                                          key: Key(
                                              'Keyq9l_${produtosAddIndex}_of_${produtosAdd.length}'),
                                  ...
                                  Expanded(
                                    child: TextFormField(
                                      controller: _model.textController ??=
                                        ...
                                        text: editarPedidoPedidosRecord
