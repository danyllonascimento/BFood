  ...
  Widget build(BuildContext context) {
    return StreamBuilder<CategoriasRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final editarCategoriaCategoriasRecord = snapshot.data!;
          ...
          child: Scaffold(
            ...
            floatingActionButton: FloatingActionButton.extended(
              onPressed: () async {
                ...
                await widget!.categoriaRef!.update(createCategoriasRecordData(
                  ...
                  imagem: valueOrDefault<String>(
                    _model.uploadedFileUrl != null &&
                        ...
                        : editarCategoriaCategoriasRecord.imagem,
                    'https://storage.googleapis.com/flutterflow-io-6f20.appspot.com/projects/food-mesa-f122za/assets/n40trpsxz1kb/IconApp.png',
                  ),
                ));
                context.safePop();
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(
                    content: Text(
                      'Dados da categoria atualizado com sucesso!',
                      style: TextStyle(
