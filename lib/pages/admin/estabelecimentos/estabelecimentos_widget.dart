...
class _EstabelecimentosWidgetState extends State<EstabelecimentosWidget>
  ...
  void initState() {
    ...
    _model.textFielEmailTextController ??= TextEditingController();
    _model.textFielEmailFocusNode ??= FocusNode();

    _model.textFielSloganTextController ??= TextEditingController();
    _model.textFielSloganFocusNode ??= FocusNode();
                    ...
                    children: [
                                    ...
                                    child: Container(
                                      ...
                                      child: Image.network(
                                        valueOrDefault<String>(
                                          ...
                                          'https://images.unsplash.com/photo-1550547660-d9450f859349?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHwyfHxmYXN0Zm9vZHxlbnwwfHx8fDE3MDc3NDA3OTJ8MA&ixlib=rb-4.0.3&q=80&w=1080',
                                        ),
                                        fit: BoxFit.cover,
                                      ),
                                    ),
                      ...
                      Padding(
                        padding: EdgeInsetsDirectional.fromSTEB(
                            16.0, 16.0, 16.0, 0.0),
                        child: TextFormField(
                          controller: _model.textFielEmailTextController,
                          focusNode: _model.textFielEmailFocusNode,
                          autofocus: false,
                          obscureText: false,
                          decoration: InputDecoration(
                            labelText: 'Email',
                          ...
                          validator: _model.textFielEmailTextControllerValidator
                              .asValidator(context),
                        ),
                      ),
                      Padding(
                        padding: EdgeInsetsDirectional.fromSTEB(
                            16.0, 16.0, 16.0, 0.0),
                        child: TextFormField(
                          controller: _model.textFielSloganTextController,
                          focusNode: _model.textFielSloganFocusNode,
                          autofocus: false,
                          obscureText: false,
                          decoration: InputDecoration(
                            labelText: 'Slogan',
                            ...
                            Expanded(
                              child: FFButtonWidget(
                                onPressed: () async {
                                  ...
                                  await EstabelecimentosRecord.collection
                                      .doc()
                                      .set(createEstabelecimentosRecordData(
                                        nome: _model
                                            .textFieldNomeTextController.text,
                                        createdTime: getCurrentTimestamp,
                                        slogan: _model
                                            .textFielSloganTextController.text,
                                        ...
                                        telefone: _model
                                            ...
                                            .text,
                                        email: _model
                                            .textFielEmailTextController.text,
                                        active: false,
                                      ));
                                  setState(() {
                                    _model.textFieldNomeTextController?.clear();
                                    _model.textFielEmailTextController?.clear();
                                    _model.textFielSloganTextController
                                        ?.clear();
