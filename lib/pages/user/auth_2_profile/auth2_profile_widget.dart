    ...
    return AuthUserStreamWidget(
      builder: (context) => StreamBuilder<EstabelecimentosRecord>(
        ...
        builder: (context, snapshot) {
          ...
          final auth2ProfileEstabelecimentosRecord = snapshot.data!;
                                  ...
                                  child: Align(
                                    ...
                                    child: Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(
                                          0.0, 0.0, 0.0, 8.0),
                                      child: Text(
                                        auth2ProfileEstabelecimentosRecord.nome,
                        ...
                        child: InkWell(
                          ...
                          onTap: () async {
                            if (valueOrDefault<bool>(
                              ...
                              context.pushNamed('Editar_Estabelecimento');
                            } else {
                              context.pushNamed('Editar_Perfil_garcom');
                            }
                          },
                          child: Container(
                            width: double.infinity,
